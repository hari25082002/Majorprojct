...
# Directory paths
input_directory = r'C:\Users\hsri2\Desktop\HTML _ css codes\majorproject\Faces\try'
output_directory = 'processed_images_chandu'
...
print("Processing and augmentation complete. Images saved in the 'processed_images_chandu' directory.")
